    ...
    def get_new_value():
        try:
            ...
            if not (0 <= new_value_decimal <= 255):
                raise ValueError("Enter between from 0 to 255.")
                ...
                while True:
                    ...
                    if choice == 0:
                        ...
                        while True:
                            ...
                            for key, description in procedure_codes.items():
                                print(f"{key}. {description}")
                            try:
                                procedure_choice = int(input("Select: "))
                                if procedure_choice == 0:
                                    break
                                if procedure_choice not in procedure_codes:
                                    raise ValueError("Wrong Choice.")
                        ...
                        while True:
                            ...
                            for key, description in protocol_ie_ids.items():
                                print(f"{key}. {description}")
                            try:
                                protocol_choice = int(input("Select: "))
                                if protocol_choice == 0:
                                    break
                                if protocol_choice not in protocol_ie_ids:
                                    raise ValueError("Wrong Choice.")
